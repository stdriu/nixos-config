{
  ...
  config = lib.mkIf config.home.matugen.enable {
    home.file."${matugenAbsPath}/kvantum-colors.kvconfig".text = ''
      [%General]
      ...
      window.text.color={{colors.on_primary_container.default.hex}}
      button.text.color={{colors.on_primary_container.default.hex}}
